...
# Read secrets – the keys must match exactly
CLIENT_ID = st.secrets["1106299230"]          # e.g., "1106299230"
PIN = st.secrets["009988"]                 # your 6‑digit Dhan PIN
TOTP_SECRET = st.secrets["DJUQ7WLHTV2ZVFHOTOORRT3VGHQJCMLV"]      # from Dhan TOTP setup
...
def _refresh_token():
    try:
        ...
        if resp.status_code == 200 and "accessToken" in data:
            ...
            # Use API expiry if provided, else fallback 23 hours
